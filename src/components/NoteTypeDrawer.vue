<template>
  <div
    ...
    class="fixed top-0 left-0 right-0 drawer-note w-full p-10 overflow-y-auto transition-transform bg-white dark:bg-gray-800 transform-none flex flex-col justify-center"
  >
    Skip
  </div>
  <div
  ...
  >
    <button
      ...
      :key="option.name"
      type="button"
      class="text-blue-700 hover:text-white overflow-y-auto border border-blue-700 font-medium rounded-lg text-sm px-10 py-5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white"
